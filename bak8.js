...
(async function (){
    ...
    for (step = 423470000; step < 423480000; step++){ //크롤링 Page 범위
        await parsing(step);
...
/**
 * 2022년 07월08일 문제 보고 메모
 * https://www.daangn.com/articles/423446598번 게시글
 * '어린이 초등 영어 - let's go / teacher's book 5권 일관판매 합니다.'라는 Title에서 Let's go의 작은 따옴표 떄문에 에러 발생하는 것으로 추측됨.
 * 문제점: 작은 따옴표를 필터링하는 게 선별하는 코드 부분에 있지 않음. 쉼표만 제거 해서 문제가 됨.
 * 07월08일 해결됨!
 */